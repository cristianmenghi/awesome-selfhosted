...
### Video Streaming
  ...
  * [Shinobi](https://moeiscool.github.io/Shinobi/) - Open Source CCTV software written in Node.JS ( IP Camera Recorder ). ([Source Code](https://github.com/moeiscool/Shinobi)) `GPLv2` `Nodejs`
